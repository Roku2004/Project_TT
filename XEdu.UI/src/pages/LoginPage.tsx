...
const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    if (state.isAuthenticated && state.user && !state.loading) {
      console.log('User authenticated, redirecting...', state.user.role); // Debug log
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check immediately after login success
      console.log('Login successful, checking auth state...', state); // Debug log
    } catch (error) {
