        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/exams" className="text-gray-300 hover:text-white transition-colors">
                  Thi online
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">contact@xedu.vn</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">Hồ Chí Minh, Việt Nam</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 xEdu. Tất cả quyền được bảo lưu.
            </p>
